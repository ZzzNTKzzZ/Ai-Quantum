...
## 🔧 Hướng Dẫn Cài Đặt Dữ Liệu Lõi Cho `d.ipynb` (HMM-LightGBM)

Thư mục dự án đã cấu hình `.gitignore` chặn tải lên các tệp dữ liệu lớn. Nếu bạn tải dự án này về và được cấp (hoặc giải nén) thư mục chứa bộ dữ liệu mồi `d_notebook_data`, hãy **chuyển 4 tệp dữ liệu đó vào đúng các vị trí sau** trước khi chạy Notebook:
...
Sau khi dán 4 tệp này vào đúng các thư mục như trên, bạn có thể mở `notebooks/d.ipynb` và chọn **Run All** một mạch từ trên xuống dưới mà không lo gặp lỗi thiếu Data!
